      ...
      <footer className="bg-white border-t border-blue-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* About TutrOS */}
            <div>
              <h3 className="text-lg font-semibold text-blue-900 mb-4">About TutrOS</h3>
            ...
            {/* Services */}
            <div>
              <h3 className="text-lg font-semibold text-blue-900 mb-4">Our Core Services</h3>
              <ul className="space-y-3 text-sm text-gray-600">
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2 mt-1">•</span>
                  <div>
                    <strong>Tutoring services</strong> for secondary and tertiary education levels
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2 mt-1">•</span>
                  <div>
                    <strong>Educational seminars</strong> focused on academic development and skills enhancement
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2 mt-1">•</span>
                  <div>
                    <strong>Technology and IT workshops</strong>, including artificial intelligence awareness and digital literacy programs
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-600 text-sm leading-relaxed space-y-3">
                <p>
                  Leveraging a strong technical foundation and growing expertise in the education industry, Technovo Enterprise continues to deliver innovative training, digital platforms, and tailored solutions for the Malaysian market.
                </p>
                <div>
                  <p className="font-medium mb-2">For further information, please contact:</p>
                  <a 
                    href="mailto:muhaimin901227@gmail.com" 
                    className="text-blue-600 hover:text-blue-700 font-medium flex items-center inline-flex"
                  >
                    <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                    </svg>
                    muhaimin901227@gmail.com
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-500">
                © 2024 Technovo Enterprise. All rights reserved.
              </p>
              <div className="flex items-center space-x-2 mt-2 md:mt-0">
                <span className="text-sm text-gray-500">Powered by</span>
                <span className="text-sm font-semibold text-blue-600">TutrOS</span>
                <span className="text-sm text-gray-500">- Your Tutor Operating System</span>
              </div>
            </div>
          </div>
        </div>
